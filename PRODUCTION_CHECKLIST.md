...
| 18 | Расписание работает | **WARNING** | Новый cron основного workflow `7 * * * *` и daily cron `17 8 * * *` корректны, workflows активны. Для нового часового расписания и ежедневного workflow ещё требуется первый фактический scheduled-run. |
